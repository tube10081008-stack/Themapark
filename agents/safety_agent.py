...
# (코드, 항목명, 주기(일), 근거)
#
# 근거 표기 주의 — 봉화군 계약서·특약은 점검 '주기'를 명시하지 않는다.
# 특약 제3조 ⑤는 "제반 설치시설의 안전관리에 최선을 다하고 수시로 점검"이라고만
# 규정한다. 아래 주기는 그 의무를 이행하기 위해 정한 **자체 기준**이며, 근거란의
# 조항은 점검 의무 자체의 출처다. (주기까지 계약에 박혀 있는 것으로 오해하지 말 것)
CHECK_ITEMS = [
    ("zip",   "짚코스터 — 와이어·하네스·브레이크·체결부", 1,  "특약 제3조⑤ (수시점검)"),
    ("net",   "네트어드벤처 — 그물 손상·고정부 유격",     1,  "특약 제3조⑤ (수시점검)"),
    ("indoor", "실내놀이시설 — 매트·구조물·모서리 보호재", 1,  "특약 제3조⑤ (수시점검)"),
    ("exit",  "비상구·피난통로 적치물 확인",              1,  "계약서 제7조⑧ (적치 금지)"),
    ("fire",  "소화기 압력·소방설비 상태",                30, "특약 제3조④ (소방기구 확보)"),
    ("elec",  "전기설비 안전점검",                        30, "계약서 제10조② (안전관리 선임)"),
    ("total", "종합 안전점검 (전 기구 정밀)",             90, "자체 기준"),
]
